...
class CourseActivityRecord(Record):
    ...
    interval_start = DateTimeField(nullable=True, description='Start time of ISO week.')
    interval_end = DateTimeField(nullable=True, description='End time of ISO week.')
